...
eq("croissant almond tracked", matchProduct("Croissant - Almond"), "Almond croissant")
eq("croissant chocolate tracked", matchProduct("Croissant - Chocolate"), "Chocolate croissant")
eq("croissant plain", matchProduct("Croissant - Plain"), "Plain croissant")
eq("crueller cinnamon tracked", matchProduct("Crueller - Cinnamon"), "Cinnamon crueller")
