/**
 * One-off: TK wage forecast for the completed Wed 10 Jun → Tue 16 Jun 2026
 ...
 *
 *   npx tsx --env-file=.env.local scripts/_wage-forecast-w20260610.ts
 */
import { Pool } from "pg"
...
// AEST Wed 10 Jun 2026 00:00 == 2026-06-09T14:00:00Z
const weekStartInstant = new Date("2026-06-09T14:00:00.000Z")
const weekEndInstant = new Date("2026-06-16T14:00:00.000Z") // Wed 17 Jun 00:00 AEST
