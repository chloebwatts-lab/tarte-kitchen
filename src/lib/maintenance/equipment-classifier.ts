...
What does NOT count (isEquipmentPurchase=false): repairs, callouts, service visits or spare PARTS for existing machines; smallwares and consumables (pans, trays, containers, utensils, crockery, chemicals, packaging); anything unpowered — shelving, racking, benches, tables, trolleys, sinks, furniture, signage; food/beverage supplier invoices; unaccepted quotes and marketing emails; our own app's automated emails. The test: would a repair tech ever be called out for it? If not, skip it. Skip individual items under roughly $150 ex GST unless they are clearly a powered appliance we'd repair rather than replace. An invoice can mix machines and non-machines: extract only the machines.
