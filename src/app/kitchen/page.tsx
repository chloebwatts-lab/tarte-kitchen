...
import { ArrowRight, CalendarCheck, ClipboardCheck, ClipboardList, Croissant, GraduationCap, PackageOpen, Printer, Ruler, Scale, ShieldCheck, ShoppingBasket, Snowflake, SprayCan, Thermometer, Wrench } from "lucide-react"
  ...
  return (
    <div className="space-y-5 md:space-y-8">
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4 lg:grid-cols-4">
        ...
        <SecondaryTile
          title="Portion guide"
          subtitle="What goes on every plate, in grams."
          icon={<Ruler className="h-6 w-6" strokeWidth={1.8} />}
          href={`/kitchen/portions?venue=${venue}`}
        />
        <SecondaryTile
          title="Coolroom serves"
          subtitle="Weight on the tub → how many full serves it holds."
          icon={<Scale className="h-6 w-6" strokeWidth={1.8} />}
          href={`/kitchen/serves?venue=${venue}`}
        />
        <SecondaryTile
          title="Cooling log"
        ...
        <SecondaryTile
          ...
          subtitle="Grease trap, pest control, fire checks: when done, when due."
          icon={<CalendarCheck className="h-6 w-6" strokeWidth={1.8} />}
          href={`/kitchen/services?venue=${venue}`}
        />
        <SecondaryTile
