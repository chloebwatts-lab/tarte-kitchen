  ...
  return (
    <div className="flex max-w-md flex-col gap-8">
      ...
      >
        ...
        <p className="text-sm text-muted-foreground">
          On each of his GM days he gets a 6:30am email with that day&apos;s list, and on Monday at 1pm a nudge if the
          report isn&apos;t sent. If it still hasn&apos;t come by 4pm Monday, you get what the app can see. Phone alerts are
          switched on from his own desk, not here.
        </p>
