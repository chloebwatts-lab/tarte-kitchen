                ...
                <table className="w-full text-sm">
                  <thead className="border-b bg-muted/40 font-serif text-[11px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left font-semibold">Bought from</th>
                      <th className="px-3 py-2 text-left font-semibold">Item</th>
                      <th className="px-3 py-2 text-right font-semibold">Qty</th>
                      <th className="px-3 py-2 text-right font-semibold">Paid</th>
                      <th className="px-3 py-2 text-left font-semibold">Should be</th>
                      <th className="px-3 py-2 text-right font-semibold">Form $</th>
                      <th className="px-3 py-2 text-right font-semibold">Overspend</th>
                    </tr>
                  </thead>
                  <tbody>
...
function StatCard({
  ...
  return (
    <div className={`rounded-xl border-[1.5px] p-4 ${toneClass}`}>
      <div className="font-serif text-[10px] font-semibold uppercase tracking-[0.14em] text-muted-foreground">{label}</div>
